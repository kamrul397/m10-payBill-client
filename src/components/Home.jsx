...
export default function Home() {
  ...
  const slides = [
    ...
    "https://plus.unsplash.com/premium_photo-1668613403113-a9af97ed6168?auto=format&fit=crop&q=80&w=870",
  ];
  ...
  return (
    <div className="p-6 space-y-16">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/40 to-black/60 backdrop-blur-[1.5px] flex flex-col items-center justify-center text-white text-center px-4">
          <Fade duration={1000} triggerOnce>
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">
              <span className="text-white drop-shadow-[0_1px_6px_rgba(0,0,0,0.6)] backdrop-blur-sm px-4 py-1 rounded-xl inline-block">
      ...
      {/* ✅ Categories (only for public view) */}
      {!user && (
        <section>
      ...
      {/* ✅ Recent Bills (user or public) */}
      <section>
        <h2 className="text-3xl font-extrabold tracking-tight text-center bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
          {user ? "Your Recent Bills" : "Recent Bills"}
        </h2>
